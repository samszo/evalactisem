...
function GetFlux(){
    ...
    document.getElementById('uti_login').setAttribute('value',"Utilisateur connecter :"+login);
    document.getElementById('Tab_nom').setAttribute('label',"Bookmark de "+login);
...
function Load(key){
 ...
 function Initialize() {
   ...
   // fonction qui est lancée à chaque changement du champs de recherche
    ...
    function ShowMsgErreur(Msg){
	    alert(Msg);
		document.getElementById('login_uti').value='';
		document.getElementById('mdp_uti').value='';
    }
    function Logout(){
