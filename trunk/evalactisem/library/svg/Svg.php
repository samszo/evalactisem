...
require_once(SVG_CLASS_BASE."SvgLinearGradient.php");
require_once(SVG_CLASS_BASE."SvgRadialGradient.php");
require_once(SVG_CLASS_BASE."SvgAnimateColor.php");
require_once(SVG_CLASS_BASE."SvgAnimateTransform.php");
require_once(SVG_CLASS_BASE."SvgScript.php");
require_once(SVG_CLASS_BASE."SvgUse.php");
