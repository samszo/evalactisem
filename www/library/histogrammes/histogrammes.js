...
function Requette(){
	...
	AjaxRequest("http://localhost/mundilogiweb/ieml-delicio.us/ieml/statistiquesAmel.php?login="+document.getElementById("login").value+"&pwd="+document.getElementById("pwd").value+"&tag="+document.getElementById("tag").value,'SetDonnees','');
